          ...
          <div className="flex-1 space-y-4">
            <div className="rounded-3xl bg-gradient-to-br from-[#0B1B3F] via-[#0E264F] to-[#0A3D8F] px-6 py-8 text-white shadow-[0_24px_45px_rgba(0,0,0,0.18)]">
              ...
              <div className="mt-4 space-y-2">
                <h1 className="text-3xl font-semibold leading-[38px]">Duyệt & chỉnh sửa listing</h1>
                <p className="max-w-2xl text-sm text-white/85">
                  Trang giả lập để dẫn hướng. Tại đây sẽ hiển thị danh sách khách sạn, bộ lọc duyệt, và thao tác nhanh.
                </p>
              </div>
            </div>
