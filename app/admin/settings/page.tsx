          ...
          <div className="flex-1 space-y-4">
            <div className="rounded-3xl bg-gradient-to-br from-[#0B1B3F] via-[#0E264F] to-[#0A3D8F] px-6 py-8 text-white shadow-[0_24px_45px_rgba(0,0,0,0.18)]">
              ...
              <div className="mt-4 space-y-2">
                <h1 className="text-3xl font-semibold leading-[38px]">Thiết lập & thông báo</h1>
                <p className="max-w-2xl text-sm text-white/85">
                  Placeholder: cấu hình banner, bảo trì, webhook thanh toán và thông báo hệ thống sẽ hiển thị ở đây.
                </p>
              </div>
            </div>

            <div className="rounded-2xl border border-[#E8E9F1] bg-white p-6 text-sm text-[#383E48] shadow-[0_14px_30px_rgba(0,0,0,0.08)]">
              Trang đang mock. Thêm form cấu hình và lưu thiết lập khi backend sẵn sàng.
            </div>
          </div>
        </div>
      </main>
