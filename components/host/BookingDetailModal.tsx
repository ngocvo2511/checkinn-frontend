...
export default function BookingDetailModal({
  ...
  const canChangeStatus = () => {
    ...
    // Nếu trạng thái là CONFIRMED và muốn chuyển sang CHECKED_IN
    if (booking.status === 'CONFIRMED') {
      ...
      // Chỉ cho phép check-in từ ngày check-in trở đi
      return checkInDate <= today;
    }
    
    // Nếu trạng thái là CHECKED_IN thì có thể check-out bất cứ lúc nào
    return true;
  };
                      ...
                      <div key={idx} className="border border-[#E8E9F1] rounded-lg p-3">
                        <div className="flex justify-between items-start mb-2">
                          <div>
                            ...
                            <p className="text-xs text-[#8B94A4]">{item.quantity} phòng × {item.nights} đêm</p>
                          </div>
